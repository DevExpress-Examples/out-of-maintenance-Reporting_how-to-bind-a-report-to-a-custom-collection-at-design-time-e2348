...
Namespace CustomCollectionDesignTime
	Partial Public Class XtraReport1
		...
		Private Sub InitializeComponent()
			...
			' xrLabel3
			' 
			Me.xrLabel3.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() { New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "Price", "{0:$0.00}")})
			Me.xrLabel3.LocationFloat = New DevExpress.Utils.PointFloat(210F, 10.00001F)
			...
			' bindingSource1
			' 
			Me.bindingSource1.DataSource = GetType(CustomCollectionDesignTime.Invoice)
			' 
			' XtraReport1
			' 
